...
TLINK = "https://telegra.ph/file/82864aab665f21ea721e5.jpg"
...
_main_help_menu = [
    ...
    [
        ...
        Button.url("❣️ YOUTUBE ❣️", url=f"https://youtube.com/c/ZEEONEOFC"),
    ],
...
SUP_BUTTONS = [
    [
        Button.url("Repo", url="https://github.com/zeeoneofc/Telegram-Alphabot"),
        Button.url("Addons", url="https://github.com/zeeoneofc/Telegram-Alphabot"),
    ],
    [Button.url("Support", url="t.me/alphabot_support")],
]
...
async def inline_alive(o):
    if len(o.text) == 0:
        ...
        WEB0 = InputWebDocument(
            "https://telegra.ph/file/82864aab665f21ea721e5.jpg", 0, "image/jpg", []
        )
        RES = [
        ...
        await o.answer(RES, switch_pm=f"👥 ALPHABOT PORTAL", switch_pm_param="start")
