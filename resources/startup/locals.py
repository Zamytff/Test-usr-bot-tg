...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to Alphabot, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    try:
        os.system("rm -rf Telegram-Alphabot")
    except BaseException:
        pass
    os.system("git clone https://github.com/zeeoneofc/Telegram-Alphabot")
    print("\n\nDone")
    os.chdir("Telegram-Alphabot")
    clear_screen()
    print(a)
    print("\n\nLet's start!\n")
    ...
    if isitdone == "y":
        # https://github.com/zeeoneofc/Telegram-Alphabot/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
        f.close
    elif isitdone == "n":
